...
namespace XORC
{
    ...
    private:
        ...
        // recently seen lines that can serve as templates. The index
        // inside the deque is what we write into the bitstream when
        // we decide to compress a line relative to a template.
