...
// line length.
constexpr int EACH_WINDOW_SIZE_COUNT = 5;  // k
...
constexpr double STATIC_L_WINDOW_ADMISSION_THRESHOLD = 0.80;
...
// Number of bits used for the per-record word bitmap written after
// every flag bit. This is metadata used by the query engine to check
// keyword presence without full decompression. The decompressor skips
// these bits. Must not be changed without recompressing all files.
constexpr int WORD_BITMAP_BITS = 64;
//====================================//
